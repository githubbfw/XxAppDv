...
import com.zhangrong.xxappdv.utlis.SlideDensityUtil;
...
public class XCSlideView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mScreenWidth = SlideDensityUtil.getScreenWidthAndHeight(context)[0];
     ...
     */
    public void attachToContentView(Activity activity, Positon positon) {
        mPositon = positon;
    ...
    public void setMenuView(Activity activity, View view) {
        ...
        if (titleFrameLayout != null) {
            layoutParams.topMargin = SlideDensityUtil.getStatusBarHeight(mContext);
        }
     ...
     * 蒙层显示开关
     */
    public void switchMaskView(boolean bShow) {
        if (bShow) {
